...
## Packages
  ...
  * [django-rest-framework-jwt](https://github.com/GetBlimp/django-rest-framework-jwt/): JSON Web Token Authentication support for Django REST Framework - ( **currently unmaintained**, [check newer fork](https://github.com/Styria-Digital/django-rest-framework-jwt) )
